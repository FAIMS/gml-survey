...
./makeElement.sh Login_Login_Logger_ID "Logger ID" input 1 false false false false false .
...
./makeElement.sh Control_Control_Next_Grinding_Groove_ID "Next Grinding Groove ID" input 1 false false false true false .
...
./makeElement.sh Feature_Artefact_New_Artefact "New Artefact" button 1 false false false false false .
./makeElement.sh Feature_Artefact_List_of_Artefact_Records "List of Artefact Records" list 1 false false false false false .
./makeElement.sh Feature_Intangible_Value_New_Intangible_Value "New Intangible Value" button 1 false false false false false .
...
./makeElement.sh Feature_Art_New_Art "New Art" button 1 false false false false false .
./makeElement.sh Feature_Art_List_of_Art_Records "List of Art Records" list 1 false false false false false .
./makeElement.sh Feature_Other_Feature_New_Other_Feature "New Other Feature" button 1 false false false false false .
...
./makeElement.sh Feature_Grinding_Groove_New_Grinding_Groove "New Grinding Groove" button 1 false false false false false .
./makeElement.sh Feature_Grinding_Groove_List_of_Grinding_Groove_Records "List of Grinding Groove Records" list 1 false false false false false .
./makeElement.sh Feature_Shell_New_Shell "New Shell" button 1 false false false false false .
./makeElement.sh Feature_Shell_List_of_Shell_Records "List of Shell Records" list 1 false false false false false .
./makeElement.sh Feature_Hearth_Ground_Oven_New_Hearth_Ground_Oven "Add Hearth/Ground Oven" button 1 false false false false false .
...
./makeElement.sh Feature_Potential_Archaeological_Deposit_New_Potential_Archaeological_Deposit "New Potential Archaeological Deposit" button 1 false false false false false .
...
./makeElement.sh Feature_Culturally_Modified_Tree_New_Culturally_Modified_Tree "New Culturally Modified Tree" button 1 false false false false false .
...
./makeElement.sh Artefact_Artefact_Artefact_Length_mm "Artefact Length (mm)" input 1 false false true false false .
./makeElement.sh Artefact_Artefact_Artefact_Width_mm "Artefact Width (mm)" input 1 false false true false false .
./makeElement.sh Artefact_Artefact_Artefact_Thickness_mm "Artefact Thickness (mm)" input 1 false false true false false .
...
./makeElement.sh Artefact_Artefact_Artefact_Photo "Artefact Photo" file 1 false false true false false .
./makeElement.sh Artefact_Artefact_Button_Artefact_Photo "Attach Photograph" button 1 false false false false false .
./makeElement.sh Artefact_Artefact_Artefact_Photo_Caption "Artefact Photo Caption" input 1 false false true false false .
...
./makeElement.sh Intangible_Value_Intangible_Value_Intangible_Value_Description "Intangible Value Description" input 1 false false true false false .
...
./makeElement.sh Art_Art_Art_Motif "Art Motif" checkbox 1 false false true false false .
./makeElement.sh Art_Art_Application_Technique "Application Technique" checkbox 1 false false true false false .
./makeElement.sh Art_Art_Art_Form "Art Form" dropdown 1 false false true false false .
./makeElement.sh Art_Art_Art_Main_Colour "Art Main Colour" dropdown 1 false false true false false .
...
./makeElement.sh Art_Art_Art_Sketch_Plan "Art Sketch Plan" file 1 false false true false false .
./makeElement.sh Art_Art_Button_Art_Sketch_Plan "Attach File" button 1 false false false false false .
./makeElement.sh Art_Art_Art_Photo "Art Photo" file 1 false false true false false .
./makeElement.sh Art_Art_Button_Art_Photo "Attach Photograph" button 1 false false false false false .
./makeElement.sh Art_Art_Art_Other_Observations "Art Other Observations" input 1 false false true false false .
./makeElement.sh Art_Art_Other_Feature_Description "Other Feature Description" input 1 false false true false false .
...
./makeElement.sh Other_Feature_Other_Feature_Other_Feature_Sketch_Plan "Other Feature Sketch Plan" file 1 false false true false false .
./makeElement.sh Other_Feature_Other_Feature_Button_Other_Feature_Sketch_Plan "Attach File" button 1 false false false false false .
./makeElement.sh Other_Feature_Other_Feature_Other_Feature_Photo "Other Feature Photo" file 1 false false true false false .
./makeElement.sh Other_Feature_Other_Feature_Button_Other_Feature_Photo "Attach Photograph" button 1 false false false false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Grinding_Groove_ID "Grinding Groove ID" input 1 false false true true false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Type_Grinding_Groove "Type Grinding Groove" dropdown 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Profile_Shape "Profile Shape" dropdown 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Seed_species_present "Seed species present" input 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Groove_function "Groove function" input 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Dimensions_-_length_of_smallest_part_mm "Dimensions - length of smallest part (mm)" input 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Dimensions_-_width_of_smallest_part_mm "Dimensions - width of smallest part (mm)" input 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Dimensions_-_depth_of_smallest_part_mm "Dimensions - depth of smallest part (mm)" input 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Dimensions_-_length_of_largest_part_mm "Dimensions - length of largest part (mm)" input 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Dimensions_-_width_of_largest_part_mm "Dimensions - width of largest part (mm)" input 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Dimensions_-_depth_of_largest_part_mm "Dimensions - depth of largest part (mm)" input 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Groove_count "Groove count" input 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Cluster_count "Cluster count" input 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Grinding_Groove_Sketch_Plan "Grinding Groove Sketch Plan" file 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Button_Grinding_Groove_Sketch_Plan "Attach File" button 1 false false false false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Grinding_Groove_Photo "Grinding Groove Photo" file 1 false false true false false .
./makeElement.sh Grinding_Groove_Grinding_Groove_Button_Grinding_Groove_Photo "Attach Photograph" button 1 false false false false false .
./makeElement.sh Shell_Shell_Shell_ID "Shell ID" input 1 false false true true false .
./makeElement.sh Shell_Shell_Shell_Distribution "Shell Distribution" dropdown 1 false false true false false .
...
./makeElement.sh Shell_Shell_Shell_Sketch_Plan "Shell Sketch Plan" file 1 false false true false false .
./makeElement.sh Shell_Shell_Button_Shell_Sketch_Plan "Attach File" button 1 false false false false false .
./makeElement.sh Shell_Shell_Shell_Photo "Shell Photo" file 1 false false true false false .
./makeElement.sh Shell_Shell_Button_Shell_Photo "Attach Photograph" button 1 false false false false false .
./makeElement.sh Hearth_Ground_Oven_Hearth_Ground_Oven_Hearth_ID "Hearth ID" input 1 false false true true false .
./makeElement.sh Hearth_Ground_Oven_Hearth_Ground_Oven_Hearth_Shape "Hearth Shape" input 1 false false true false false .
./makeElement.sh Hearth_Ground_Oven_Hearth_Ground_Oven_Hearth_Length "Hearth Length" input 1 false false true false false .
./makeElement.sh Hearth_Ground_Oven_Hearth_Ground_Oven_Hearth_Width "Hearth Width" input 1 false false true false false .
./makeElement.sh Hearth_Ground_Oven_Hearth_Ground_Oven_Hearth_Estimated_Depth "Hearth Estimated Depth" input 1 false false true false false .
./makeElement.sh Hearth_Ground_Oven_Hearth_Ground_Oven_Hearth_Components "Hearth Components" dropdown 1 false false true false false .
./makeElement.sh Hearth_Ground_Oven_Hearth_Ground_Oven_Hearth_Descriptive_Notes "Hearth Descriptive Notes" input 1 false false true false false .
./makeElement.sh Hearth_Ground_Oven_Hearth_Ground_Oven_Hearth_Sketch_Plan "Hearth Sketch Plan" file 1 false false true false false .
./makeElement.sh Hearth_Ground_Oven_Hearth_Ground_Oven_Button_Hearth_Sketch_Plan "Attach File" button 1 false false false false false .
./makeElement.sh Hearth_Ground_Oven_Hearth_Ground_Oven_Hearth_Photo "Hearth Photo" file 1 false false true false false .
./makeElement.sh Hearth_Ground_Oven_Hearth_Ground_Oven_Button_Hearth_Photo "Attach Photograph" button 1 false false false false false .
