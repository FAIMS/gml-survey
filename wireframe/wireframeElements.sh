...
mkdir -p wireframeImages
  ...
  ./makeElement.sh User_User_User "User" list 1 false false false false false wireframeImages/
  
  ./makeElement.sh Control_Control_New_Transect "" button 1 false false false false false wireframeImages/
  
  ./makeElement.sh Control_Control_New_Site "" button 1 false false false false false wireframeImages/
  
  ./makeElement.sh Control_Control_New_Feature "" button 1 false false false false false wireframeImages/
  
  ./makeElement.sh Control_Control_New_Objects_IV "" button 1 false false false false false wireframeImages/
  
  ./makeElement.sh Control_Control_New_Cultural_Management_Comments "" button 1 false false false false false wireframeImages/
  
  ./makeElement.sh Control_Control_Next_Transect_ID "" input 1 false false false true false wireframeImages/
  
  ./makeElement.sh Control_Control_Next_Site_ID_Number "" input 1 false false false true false wireframeImages/
  
  ./makeElement.sh Control_Control_Next_Feature_ID "" input 1 false false false true false wireframeImages/
  
  ./makeElement.sh Control_Control_Next_Intangible_Value_ID "" input 1 false false false true false wireframeImages/
  
  ./makeElement.sh Control_Control_Next_Other_Feature_ID "" input 1 false false false true false wireframeImages/
  
  ./makeElement.sh Control_Control_Next_Grinding_Grove_ID "" input 1 false false false true false wireframeImages/
  
  ./makeElement.sh Control_Control_Next_Shell_ID "" input 1 false false false true false wireframeImages/
  
  ./makeElement.sh Control_Control_Next_Arch_Dep_ID "" input 1 false false false true false wireframeImages/
  
  ./makeElement.sh Control_Control_Next_CM_Tree_ID "" input 1 false false false true false wireframeImages/
  
  ./makeElement.sh Control_Control_Next_Comment_ID "" input 1 false false false true false wireframeImages/
  
  ./makeElement.sh Transect_Transect_Latitude "Latitude" input 2 false false true false true wireframeImages/
  
  ./makeElement.sh Transect_Transect_Northing "Northing" input 2 false false true false true wireframeImages/
  
  ./makeElement.sh Transect_Transect_Longitude "Longitude" input 2 false false true false true wireframeImages/
  
  ./makeElement.sh Transect_Transect_Easting "Easting" input 2 false false true false true wireframeImages/
  
  ./makeElement.sh Transect_Transect_Take_From_GPS "Take From GPS" button 1 false false false false false wireframeImages/
  
  ./makeElement.sh Transect_Transect_Transect_ID "" input 1 false false true true false wireframeImages/
  ...
  ./makeElement.sh Transect_Transect_Total_Transect_Width_m "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Transect_Transect_Number_of_Participants_in_Transect "" input 1 false false true true false wireframeImages/
  ...
  ./makeElement.sh Transect_Transect_Vegetation_notes "" input 1 false false true true false wireframeImages/
  
  ./makeElement.sh Transect_Transect_Ground_surface_visibility "" input 1 false false true true false wireframeImages/
  
  ./makeElement.sh Transect_Transect_Ground_surface_exposure "" input 1 false false true true false wireframeImages/
  
  ./makeElement.sh Transect_Transect_Ground_surface_notes "" input 1 false false true false false wireframeImages/
  ...
  ./makeElement.sh Transect_Transect_Photo "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Transect_Transect_Photo_Caption "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Transect_Transect_Sketch "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Transect_Transect_Other_Notes "" input 1 false false true false false wireframeImages/
  ...
  ./makeElement.sh Transect_Map_Map "" map 1 false false false false false wireframeImages/
  
  ./makeElement.sh Transect_Map_Survey_extent "" input 1 false false true false true wireframeImages/
  
  ./makeElement.sh Site_Site_Site_ID_Number "" input 1 false false true true false wireframeImages/
  ...
  ./makeElement.sh Site_Site_Distance_to_temporary_water_source "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Site_Site_Name_of_nearest_permanent_water_source "" input 1 false false true false false wireframeImages/
  ...
  ./makeElement.sh Site_Open_Site_Average_width_of_visible_site "" input 1 false false true true false wireframeImages/
  
  ./makeElement.sh Site_Open_Site_Estimated_area_of_visible_site "" input 1 false false true true false wireframeImages/
  
  ./makeElement.sh Site_Open_Site_Length_of_assessed_site_area "" input 1 false false true true false wireframeImages/
  
  ./makeElement.sh Site_Open_Site_Subsurfance_potential "" radio 1 false false true false false wireframeImages/
  
  ./makeElement.sh Site_Open_Site_Length_of_potential_site_area "" input 1 false false true false false wireframeImages/
  ...
  ./makeElement.sh Site_Closed_Site_Internal_Width "" input 1 false false true true false wireframeImages/
  
  ./makeElement.sh Site_Closed_Site_Shelter_Height "" input 1 false false true true false wireframeImages/
  
  ./makeElement.sh Site_Closed_Site_Shelter_Floor_Area "" input 1 false false true true false wireframeImages/
  ...
  ./makeElement.sh Objects_IV_Artefact_Width_mm "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Artefact_Thickness_mm "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Artefact_Other_Observations "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Artefact_Photo "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Artefact_Photo_Caption "" input 1 false false true false false wireframeImages/
  ...
  ./makeElement.sh Objects_IV_Art_Photo "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Art_Other_Observations "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Other_Feature_Other_Feature_ID "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Other_Feature_Description "Description" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Other_Feature_Chain_of_Custody_Notes_for_human_remains "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Other_Feature_Sketch_Plan "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Other_Feature_Photo "" input 1 false false true false false wireframeImages/
  ...
  ./makeElement.sh Objects_IV_Grinding_Grove_Groove_function "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Grinding_Grove_Dimensions_-_length_of_smallest_part_mm "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Grinding_Grove_Dimensions_-_width_of_smallest_part_mm "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Grinding_Grove_Dimensions_-_depth_of_smallest_part_mm "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Grinding_Grove_Dimensions_-_length_of_largest_part_mm "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Grinding_Grove_Dimensions_-_width_of_largest_part_mm "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Grinding_Grove_Dimensions_-_depth_of_largest_part_mm "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Grinding_Grove_Groove_count "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Grinding_Grove_Cluster_count "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Grinding_Grove_Sketch_Plan "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Grinding_Grove_Photo "" input 1 false false true false false wireframeImages/
  ...
  ./makeElement.sh Objects_IV_Shell_Photo "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Hearth_Ground_Oven_Hearth_ID "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Hearth_Ground_Oven_Shape "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Hearth_Ground_Oven_Length "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Hearth_Ground_Oven_Width "" input 1 false false true false false wireframeImages/
  ...
  ./makeElement.sh Objects_IV_Hearth_Ground_Oven_Sketch_Plan "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Hearth_Ground_Oven_Photo "" input 1 false false true false false wireframeImages/
  ...
  ./makeElement.sh Objects_IV_Culturally_Modified_Tree_Width_of_Scar_mm "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Objects_IV_Culturally_Modified_Tree_Depth_of_Scar_mm "" input 1 false false true false false wireframeImages/
  ...
  ./makeElement.sh Cultural_Management_Comments_C_M_Comments_Aboriginal_community_interpretation "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Cultural_Management_Comments_C_M_Comments_Aboriginal_community_management_recommendations "" input 1 false false true false false wireframeImages/
  
  ./makeElement.sh Cultural_Management_Comments_C_M_Comments_Other_management_recommendations "" input 1 false false true false false wireframeImages/
